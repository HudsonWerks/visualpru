...
import am335x.pruss as pruss#NOTE: For different chips, you can import modules which describe the PRU hardware. The hardware-specific configuration automatically propogates throughout the app(both backend and frontend)
